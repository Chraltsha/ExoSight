...
import { n as onNavigate, r as resolve, t as page } from "../../chunks/state.js";
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!----> <nav class="navigation-bar"><!--[-->`);
		...
		$$renderer.push(`<!--]--></nav> <hr/> <div class="page-transition-wrapper">`);
		children($$renderer);
		$$renderer.push(`<!----></div>`);
	});
}
