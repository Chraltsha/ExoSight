...
function TelescopeSettings($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(
			`<div class="search-section"><span class="search-section-label">Telescope Settings</span> <div class="search-section-fields"><label class="search-field-label">Horizontal FOV (°) <input class="search-field-input" type="number" min="0" step="0.1"${attr('value', hFov)}/></label> <label class="search-field-label">Vertical FOV (°) <input class="search-field-input" type="number" min="0" step="0.1"${attr('value', vFov)}/></label></div></div>`,
		);
		bind_props($$props, {
			hFov,
			vFov,
...
function LocationSettings($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(
			`<div class="search-section"><span class="search-section-label">Location</span> <div class="search-section-fields"><label class="search-field-label">Latitude <input class="search-field-input" type="number" min="-90" max="90" step="0.000001"${attr('value', lat)}/></label> <label class="search-field-label">Longitude <input class="search-field-input" type="number" min="-180" max="180" step="0.000001"${attr('value', lon)}/></label></div> <div class="location-map"></div></div>`,
		);
		bind_props($$props, {
			lat,
			lon,
