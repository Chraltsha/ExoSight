			...
			if (others.length === 0) {
				...
				if (current_unequal.length > 0) {
					for (const effect of this.#new_effects)
						if ((effect.f & 155648) === 0 && depends_on(effect, current_unequal, checked)) {
...
export {
	...
	HYDRATION_ERROR as Q,
	set as R,
	escape_html as S,
	writable as T,
	push$1 as U,
	component_context as V,
	async_mode_flag as W,
	lifecycle_double_unmount as X,
	hydration_mismatch as Y,
	state_proxy_unmount as Z,
	hydratable_clobbering as _,
	ensure_array_like as a,
	noop as at,
	getAbortSignal as b,
	stringify as c,
	createContext as d,
	experimental_async_required as et,
	getAllContexts as f,
	ssr_context as g,
	setContext as h,
	derived as i,
	define_property as it,
	component_root as j,
	set_active_effect as k,
	get_user_code_location as l,
	hasContext as m,
	attr_style as n,
	STATE_SYMBOL as nt,
	head as o,
	run as ot,
	getContext as p,
	set_hydrate_node as q,
	bind_props as r,
	array_from as rt,
	render as s,
	attr_class as t,
	LEGACY_PROPS as tt,
	get_render_context as u,
	hydratable_serialization_failed as v,
	readable as w,
	attr as x,
